...
export declare function transformReplyBufferNull(reply: Buffer | null): Buffer | null;
...
export declare function pushVerdictArguments(args: TransformArgumentsReply, value: string | Buffer | Array<string | Buffer>): TransformArgumentsReply;
